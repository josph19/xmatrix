...
# Replace your MANUAL mode block with this updated version
    ...
    st.subheader("Relations Objectifs stratégiques et Objectifs annuels")
    strat_annual_matrix = {}
    ...
    st.subheader("Relations Objectifs annuels et Priorités")
    ...
    st.subheader("Relations Priorités et KPIs")
    priority_kpi_matrix = {}
    for priority in improvement_priorities:
    ...
    st.subheader("Relations Priorités et Responsables")
